...
public class Game
{
    ...
    public void Start()
    {
        audioPlayer.PlaySound(@"C:\Users\Rog\Desktop\pdrb\задний фон.mp3");
    ...
    private void PlaceBet()
    {
        ...
        while (true)
        {
            ...
            else
            {
                ...
                audioPlayer.PlaySound(@"C:\Users\Rog\Desktop\pdrb\7689335a082e02b.mp3");
    ...
    private void DetermineWinner()
    {
        ...
        if (playerPoints > 21)
        {
            ...
            audioPlayer.PlaySound(@"C:\Users\Rog\Desktop\pdrb\fail-wha-wha-version.mp3");
        ...
        else if (dealerPoints > 21 || playerPoints > dealerPoints)
        {
            ...
            playerMoney += currentBet * 2;
            audioPlayer.PlaySound(@"C:\Users\Rog\Desktop\pdrb\z_uki-pobeda-2.mp3");
